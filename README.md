...
1. [Linked Lists](singly-linked-lists.md)
...
1. [Arrays](code-challenges/arrays)
    ...
    1. [Max Points](code-challenges/arrays/max-points.md)
...
1. [Trees](code-challenges/trees)
    1. [Validate BST](code-challenges/trees/validate-bst.md)
    1. [Lowest Common Ancestor BST](code-challenges/trees/lowest-common-ancestor.md)
